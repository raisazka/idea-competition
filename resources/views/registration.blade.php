...
<body>
    ...
    <form action="{{route('user.register')}}" method="post" class="form-form-form" enctype="multipart/form-data">
        ...
        <div class="content-promosi text-center container">
            ...
            <h3>Registration Deadline : 22 June 2019</h3>
        </div>
        ...
        <div class="container-fluid form-container " id="info">
            <div class="row">
            <a href="{{url('user-login')}}"><h5 class="col-12" style="text-decoration:underline; cursor:pointer;" id="try">Already have account? Login now</h5></a>
            </div>
        </div>
    </form>
